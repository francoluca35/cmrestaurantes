...
const CuotasSelector = ({ total, onCuotasChange, tipoTarjeta, moneda = 'usd' }) => {
          ...
          >
            <div className="text-center">
              ...
              <div className="text-lg font-bold">
                ${calcularCuota(opcion.cuotas).toLocaleString()} {moneda.toUpperCase()}
              </div>
              {opcion.cuotas > 1 && (
                <div className="text-xs text-gray-500">
                  Total: ${total.toLocaleString()} {moneda.toUpperCase()}
                </div>
              )}
            </div>
          </motion.button>
