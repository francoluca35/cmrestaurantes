...
export default function PagoPage() {
  ...
  const calcularDesglose = () => {
    ...
    // Calcular valores en ARS si es necesario
    const valorDolar = 1000 // Valor aproximado del dólar
    const precioBaseARS = precioBase * valorDolar
                  ...
                  {moneda === 'ars' && (
                    <>
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">${(desglose.precioBase * 1000).toLocaleString()} ARS</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-300">Recargo del 15%:</span>
                        <span className="text-yellow-400">${(desglose.precioBase * 1000 * 0.15).toLocaleString()} ARS</span>
                      </div>
                      <div className="flex justify-between border-t border-gray-600 pt-2">
                        <span className="text-gray-300 font-semibold">Total con recargo:</span>
                        <span className="text-green-400 font-bold">${desglose.total.toLocaleString()} ARS</span>
                      </div>
                    </>
                  )}
