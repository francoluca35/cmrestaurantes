...
export default function PagoPage() {
  ...
  const handlePagoTarjeta = async (datosTarjeta, tipoTarjeta) => {
    setProcesando(true)
    ...
    setTimeout(() => {
      setProcesando(false)
      alert(`¡Pago procesado con tarjeta ${tipoTarjeta.toUpperCase()}! Redirigiendo al dashboard...`)
    }, 2000)
  }
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-4 pt-4">
                      <motion.button
                        ...
                        whileTap={{ scale: procesando ? 1 : 0.98 }}
                      >
                        {procesando ? 'Procesando...' : `Pagar $${desglose.total}.00 USD`}
                      </motion.button>
                      ...
                      <motion.button
                        ...
                        disabled={procesando}
                        className="px-6 py-3 border-2 border-gray-500 text-gray-300 rounded-lg hover:border-gray-400 hover:text-white transition-all duration-200"
                        whileHover={{ scale: procesando ? 1 : 1.02 }}
                        whileTap={{ scale: procesando ? 1 : 0.98 }}
                      >
                        Cancelar
