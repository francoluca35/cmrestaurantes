  ...
  try {
    ...
    try {
      const restaurantData = {
        ...
        plan: plan,
        precioBase: datosRestaurante.precioBase || (plan === 'anual' ? 420 : 42),
        precioTotal: total,
        moneda: moneda,
        
        // Configuración adicional
        logoUrl: datosRestaurante.logoUrl || '',
      ...
      console.log('Restaurante registrado con ID:', restaurantId);
    } catch (error) {
