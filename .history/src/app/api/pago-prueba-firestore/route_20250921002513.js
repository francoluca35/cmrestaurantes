...
export async function POST(request) {
  try {
    ...
    // 1. Guardar en la colección 'restaurantes' como documento principal
    ...
    const codigoRef = await addDoc(collection(db, 'codigosactivacion'), codigoData);
    console.log('Código de activación guardado con ID:', codigoRef.id);
