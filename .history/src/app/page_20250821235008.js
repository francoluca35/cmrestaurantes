        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Simplificamos, diseñamos e innovamos para hacer que tu restaurante funcione perfectamente.
              Sin complicaciones, sin papeles, sin problemas.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:shadow-xl transition-shadow">
                ¡Probalo Ahora!
              </button>
              <button className="border-2 border-orange-500 text-orange-500 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-orange-50 transition-colors">
                Ver Demo
              </button>
            </div>
          </div>
