    ...
    <section ref={containerRef} className="py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div 
          ...
          className="flex justify-center items-center mb-12 sm:mb-16 lg:mb-20 w-full"
        >
          <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-4 sm:gap-6 w-full max-w-4xl">
          {featureCategories.map((category, index) => (
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <div className={`w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 mx-auto mb-2 sm:mb-3 group-hover:scale-110 transition-transform duration-300 ${category.color}`}>
                {category.icon}
              </div>
        ...
        <motion.div 
          ...
          className="space-y-6 sm:space-y-8 lg:space-y-10 flex justify-center w-full"
        >
