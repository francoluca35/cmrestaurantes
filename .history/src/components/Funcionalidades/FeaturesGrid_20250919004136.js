      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight">
            Lo que necesitás en la palma de tu mano
          </h2>
        </div>
        ...
        >
     <div className="flex flex-wrap justify-center gap-11 max-w-6xl mx-auto">
            ...
            >
              {row.map((feature, featureIndex) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                >
                  <p className="text-sm sm:text-base lg:text-sm text-white text-center leading-relaxed">
                    {feature.text}
                  </p>
                </motion.div>
              ))}
