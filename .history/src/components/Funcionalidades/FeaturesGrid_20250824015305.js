    ...
    <section ref={containerRef} className="py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div 
          ...
          className="flex justify-center items-center mb-12 sm:mb-16 lg:mb-20"
        >
          <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-4 sm:gap-6 max-w-6xl mx-auto">
