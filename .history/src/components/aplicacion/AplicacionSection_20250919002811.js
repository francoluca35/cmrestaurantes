      ...
      <div className="w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {/* Iconos con X roja */}
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-8 max-w-6xl mx-auto justify-items-center">
              {howWeDoItItems.map((item, index) => (
                <motion.div 
                  key={index}
                  className={`relative text-center group ${index === 4 ? 'col-start-1 col-span-2 lg:col-start-auto lg:col-span-auto' : ''}`}
