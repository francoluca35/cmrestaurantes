...
export default function PrecioSection() {
  return (
    <section className="py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 bg-gradient-to-br from-gray-900 to-purple-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="bg-gradient-to-br from-purple-900/50 to-gray-800/50 backdrop-blur-sm border-2 border-purple-500/30 rounded-2xl p-8 sm:p-12 lg:p-16 shadow-2xl">
            
            {/* Precio */}
            <div className="text-center mb-8 sm:mb-12">
              <div className="flex items-baseline justify-center mb-4">
                <span className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white">$</span>
                <span className="text-6xl sm:text-7xl lg:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 mx-2">
                  29
                </span>
                <span className="text-2xl sm:text-3xl text-gray-300">/mes</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 sm:mb-12">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-200">3 Usuarios de manera predeterminada</span>
                </div>
              </div>
            </div>
