...
export default function PrecioSection() {
  const [selectedPlan, setSelectedPlan] = useState('anual') // 'mensual' or 'anual'
  const router = useRouter()

  const handleSubscribe = (plan) => {
    const precio = plan === 'anual' ? '$420/año' : '$42/mes'
    router.push(`/registro?plan=${plan}&precio=${encodeURIComponent(precio)}`)
  }

  const handleWhatsAppClick = () => {
    const message = "Hola, me gustaria probar su aplicacion, vengo de la pagina de quicksolutions."
    const phoneNumber = "5491131199882"
    ...
    <section className="py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 bg-gradient-to-br from-gray-900 to-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          >
            {/* Badge de descuento */}
            <div className="absolute top-2 -right-5 bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-full text-sm font-bold transform rotate-45">
              ¡20% OFF!
            </div>
            ...
            {/* Botones de acción */}
            <div className="flex flex-col gap-4 justify-center">
              <h3 className="text-white text-center -mb-1 ">¡Ahorra con el plan anual!</h3>
              <motion.button 
          ...
          {/* Comparación de Precios Interactiva */}
          <motion.div 
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 mb-6">Haz clic en un plan para ver sus beneficios</p>
            </div>

            <div className="space-y-4">
              {/* Plan Mensual - Clickeable */}
              <motion.button
                onClick={() => setSelectedPlan('mensual')}
                className={`w-full rounded-lg p-4 transition-all duration-200 ${
                  selectedPlan === 'mensual' 
                    ? 'bg-purple-900/50 border-2 border-purple-500/50 shadow-lg' 
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-cyan-400 font-bold">$42/mes</span>
                </div>
              ...
              {/* Plan Anual - Clickeable */}
              <motion.button
                onClick={() => setSelectedPlan('anual')}
                className={`w-full rounded-lg p-4 transition-all duration-200 ${
                  selectedPlan === 'anual' 
                    ? 'bg-cyan-900/50 border-2 border-cyan-500/50 shadow-lg' 
                    : 'bg-gray-800/50 hover:bg-gray-700/50'
                }`}
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-cyan-400 font-bold">$36/mes</span>
                </div>
            ...
            >
              {selectedPlan === 'mensual' ? (
                <div className="bg-purple-900/30 rounded-lg p-4">
                  <h4 className="text-white font-semibold mb-3">Beneficios del plan mensual:</h4>
                  <ul className="space-y-2 text-sm text-gray-300">
                    ...
                    <li className="flex items-center space-x-2">
                      ...
                      <span>Pago mensual sin sorpresas</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                      <span>Ideal para probar el servicio</span>
                    </li>
                  </ul>
                </div>
              ) : (
                <div className="bg-cyan-900/30 rounded-lg p-4">
                  ...
                  <ul className="space-y-2 text-sm text-gray-300">
                    <li className="flex items-center space-x-2">
                      ...
                      <span>20% de descuento en el precio total</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="text-center mt-8">
             ...
             <motion.a 
                 href={`https://wa.me/5491131199882?text=${encodeURIComponent(
                   selectedPlan === 'mensual' 
                     ? 'Hola!, queria saber mas acerca del plan mensual.'
                     : 'Hola!, queria saber mas acerca del plan anual.'
                 )}`}
                 target="_blank"
                 rel="noopener noreferrer"
                 className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-6 py-2 rounded-lg text-lg font-semibold hover:shadow-xl transition-all duration-200 transform hover:scale-105 inline-block"
                 whileHover={{ scale: 1.05 }}
                 whileTap={{ scale: 0.95 }}
               >
                 ¡Contactanos!
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Garantía de confidencialidad</h3>
              <p className="text-gray-300">Por contrato los datos de cada restaurante quedan en total privacidad</p>
            </div>
