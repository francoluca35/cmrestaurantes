    ...
    <section className="py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 bg-gradient-to-br from-gray-900 to-purple-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="bg-gradient-to-br from-purple-950/50 to-gray-800/50 backdrop-blur-sm border-2 border-purple-500/30 rounded-2xl p-8 sm:p-12 lg:p-16 shadow-2xl">
