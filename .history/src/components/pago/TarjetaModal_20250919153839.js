    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Modal */}
          <motion.div
            className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[100vh] overflow-y-auto"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength="19"
                    className="w-full pl-2 px-4 py-3 border border-gray-300 rounded-lg  focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-black"
                  />
                </div>
