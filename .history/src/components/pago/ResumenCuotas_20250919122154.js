...
const ResumenCuotas = ({ total, cuotas, tipoTarjeta }) => {
    ...
    >
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-sm">
          ...
          <span className="font-semibold">${total}.00 USD</span>
        </div>
        <div className="flex justify-between text-sm">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className="font-semibold text-green-600">${cuotaMensual.toFixed(2)} USD</span>
        </div>
      </div>
