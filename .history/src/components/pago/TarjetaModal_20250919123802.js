...
const TarjetaModal = ({ isOpen, onClose, onPagar, total, moneda = 'usd' }) => {
        ...
        >
          ...
          >
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-600 mt-2">Total a pagar: <span className="font-semibold text-green-600">${total}.00 USD</span></p>
            </div>
              ...
              <div className="flex space-x-4 pt-4">
                ...
                >
                 ...
                 >
                   {cuotas === 1 
                     ? `Pagar $${total}.00 USD` 
                     : `Pagar ${cuotas} cuotas de $${(total / cuotas).toFixed(2)} USD`
                   }
                 </button>
              </div>
            </div>
