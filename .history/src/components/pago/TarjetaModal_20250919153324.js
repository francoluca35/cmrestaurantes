              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength="19"
                    className="w-full px-5 py-4 text-lg border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 focus:outline-none transition-all duration-200 text-gray-800 bg-gray-50 hover:bg-white hover:border-gray-300"
                  />
                </div>
