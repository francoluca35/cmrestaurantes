...
export default function Navbar() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      isScrolled 
        ? 'bg-violet-900/90 backdrop-blur-md shadow-lg' 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden sm:flex space-x-4 md:space-x-6">
            {/* Instagram */}
            <a 
              href="https://instagram.com/cmrestaurantes" 
              target="_blank" 
            ...
            {/* YouTube */}
            <a 
              href="https://youtube.com/@cmrestaurantes" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-100 hover:text-red-600 transition-colors duration-300"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button className={`px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-2 rounded-lg hover:shadow-lg transition-all duration-300 text-xs sm:text-sm md:text-base ${
            isScrolled 
