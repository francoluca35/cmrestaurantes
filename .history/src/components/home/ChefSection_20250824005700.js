...
export default function ChefSection() {
  return (
       ...
       <div className="absolute inset-0 bg-gradient-to-r from-violet-800 via-violet-800/90 to-gray-800/80"></div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-6 lg:gap-12 items-center w-full">
           
           {/* Lado izquierdo con color sólido */}
           <div className="h-full flex items-center justify-center order-2 lg:order-1">
