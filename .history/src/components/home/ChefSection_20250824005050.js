...
export default function ChefSection() {
  return (
    <section className="relative overflow-visible h-[400px] ">
                    {/* Fondo sólido para el lado izquierdo */}
       <div className="absolute inset-0 bg-pink-500"></div>
       
       {/* Fondo con imagen solo para el lado derecho */}
       <div className="absolute inset-0 lg:left-1/2 bg-cover bg-center"
         style={{ 
           backgroundImage: "url('/Assets/fondo-interludio.jpg')"
         }}
       ></div>
       <div className="absolute inset-0 lg:left-1/2 bg-gradient-to-r from-pink-500/30 to-rose-500/30"></div>
