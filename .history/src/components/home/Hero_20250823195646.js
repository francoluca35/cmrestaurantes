  ...
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        {/* Header Section - Logo TOP TOP CHEF */}
        ...
        {/* Device Showcase - Exactamente como en la imagen */}
        <div className="relative flex justify-center items-center">
          {/* Central Tablet (Main Focus) */}
          ...
          <div className="absolute -left-20 top-16 transform -rotate-8 hover:rotate-0 transition-transform duration-300 z-10">
            <div className="w-80 h-96 bg-gray-900 rounded-2xl shadow-xl border-4 border-gray-800 relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900"></div>
          ...
          <div className="absolute -bottom-12 right-12 transform rotate-15 hover:rotate-0 transition-transform duration-300 z-30">
            <div className="w-40 h-56 bg-gradient-to-br from-pink-400 to-purple-500 rounded-2xl shadow-xl border-4 border-pink-300 relative overflow-hidden">
