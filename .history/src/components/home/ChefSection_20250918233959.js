...
export default function ChefSection() {
  return (
    <section className="relative overflow-visible h-[350px] sm:h-[400px] md:h-[450px]">
       ...
       <div className="absolute inset-0 bg-gradient-to-r from-purple-950 via-violet-800/70 to-gray-800/60"></div>

             <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
         <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 lg:gap-8 xl:gap-12 items-center w-full">
           
           {/* Lado izquierdo con color sólido */}
           <div className="h-full flex items-start lg:items-center justify-center w-full lg:w-auto py-8 lg:py-0">
             <div className="text-white text-center lg:text-left space-y-6 sm:space-y-8 md:space-y-10 lg:space-y-6">
