    ...
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-violet-950 to-gray-700">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 flex justify-center items-center max-w-screen-xl">
            <div className="relative z-20 max-w-screen-xl flex justify-center">
              <Image
                src="/Assets/FONDOOFICIAL.png"
                alt="Pantalla principal del sistema"
                width={2500}
                height={2500}
                className="w-full max-w-[2000px] lg:max-w-[2500px] h-auto object-contain"
                priority
              />
            </div>
          </div>
