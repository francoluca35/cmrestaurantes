...
export default function Hero() {
  return (
    <section className="relative py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-violet-950 to-gray-700 z-10 min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto w-full">
        {/* Layout responsive */}
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left max-w-2xl lg:max-w-none">
