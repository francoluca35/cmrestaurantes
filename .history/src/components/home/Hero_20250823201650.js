  ...
  return (
    <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-violet-950 to-gray-700">
      <div className="max-w-7xl mx-auto">
        {/* En móviles/tablets es stack, en PC (lg+) es grid */}
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative flex justify-center items-center">
              <div className="relative z-20 w-full">
                <img
                  ...
                  className="max-w-screen-md h-auto object-contain rounded-xl"
                />
              </div>
            </div>
          </div>
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-200 mb-6">
