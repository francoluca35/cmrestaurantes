        ...
        <div className="flex flex-col xl:grid xl:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="order-2 xl:order-1 text-center xl:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center xl:justify-start">
              <button className="bg-gradient-to-l from-violet-700 to-gray-900 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:shadow-xl transition-all duration-200 transform hover:scale-105">
