...
export default function ChefSection() {
  return (
    <section className="relative overflow-visible h-[350px] sm:h-[400px] md:h-[450px]">
       {/* Fondo con imagen - Solo visible en desktop */}
       ...
       {/* Gradiente que difumina del color sólido hacia la imagen - Solo en desktop */}
       <div className="hidden lg:block absolute inset-0 bg-gradient-to-r from-violet-800 via-violet-800/70 to-gray-800/60"></div>

       {/* Fondo sólido para mobile */}
       <div className="lg:hidden absolute inset-0 bg-violet-800"></div>
         ...
         <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center w-full">
           ...
           {/* Lado derecho - Solo visible en desktop con imagen de fondo */}
           <div className="hidden lg:flex h-full items-center justify-center">
             <div className="text-white text-6xl xl:text-7xl 2xl:text-8xl font-bold opacity-20">
               Quick Solution
             </div>
           </div>
