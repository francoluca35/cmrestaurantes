...
export default function ChefSection() {
  return (
    <section className="relative overflow-visible h-[350px] sm:h-[400px] md:h-[450px]">
       {/* Fondo con imagen - Visible en todas las pantallas */}
       ...
       <div className="absolute inset-0 bg-gradient-to-r from-violet-800 via-violet-800/70 to-gray-800/60"></div>

             <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
         <div className="grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12 items-center w-full">
           ...
           {/* Lado derecho - Quick Solution visible en todas las pantallas */}
           <div className="flex h-full items-center justify-center">
             <div className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold opacity-30 text-center">
               <div>Quick</div>
               <div>Solution</div>
             </div>
           </div>
