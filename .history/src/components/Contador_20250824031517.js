        ...
        >
          ...
          <div className="flex items-baseline justify-center lg:justify-start">
            ...
            <div className="ml-3 text-left">
              <div className="text-lg sm:text-xl font-bold text-white">AÑOS</div>
              <div className="text-lg sm:text-xl font-bold text-white">EN EL</div>
              <div className="text-lg sm:text-xl font-bold text-white">RUBRO</div>
            </div>
