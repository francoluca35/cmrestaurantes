...
export default function Contador() {
  ...
  return (
    <section className="py-10 sm:py-14 bg-[#242525] relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-16 flex items-end justify-center space-x-0.5 px-4">
          {[...Array(30)].map((_, i) => (
            <motion.div
              key={i}
              className="w-0.5 bg-[#8B5CF6] rounded-t"
              animate={{
                height: [
                  Math.random() * 15 + 3,
                  Math.random() * 35 + 15,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="flex items-baseline justify-center lg:justify-start">
            <span className="text-6xl md:text-7xl font-bold text-gray-950">
              {yearsDisplay}
            </span>
            <div className="ml-3 text-left">
              <div className="text-lg sm:text-xl font-bold text-gray-950">AÑOS</div>
              <div className="text-lg sm:text-xl font-bold text-gray-950">EN EL</div>
              <div className="text-lg sm:text-xl font-bold text-gray-950">RUBRO</div>
            </div>
