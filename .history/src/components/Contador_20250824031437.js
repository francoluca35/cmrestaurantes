      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="flex items-baseline justify-center lg:justify-start">
            <span className="text-6xl md:text-7xl font-bold text-violet-950">
              {yearsDisplay}
            </span>
            <div className="ml-3 text-left">
              <div className="text-lg sm:text-xl font-bold text-violet-950">AÑOS</div>
              <div className="text-lg sm:text-xl font-bold text-violet-950">EN EL</div>
              <div className="text-lg sm:text-xl font-bold text-violet-950">RUBRO</div>
            </div>
